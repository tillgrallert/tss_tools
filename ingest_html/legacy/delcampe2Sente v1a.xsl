...
tell application "TextEdit"
    ...
    <xsl:template name="templReferencesM5">
        ...
        <xsl:for-each select="a">
            ...
            <xsl:variable name="vAucID" select="substring-before(substring-after(./@href,'id,'),',var')"/>
            ...
            <xsl:value-of select="concat($vUrl1,'00',$vUrl2,$vUrl3,'1.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'00',$vUrl2,$vUrl3,'2.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'01',$vUrl2,$vUrl3,'1.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'01',$vUrl2,$vUrl3,'2.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'02',$vUrl2,$vUrl3,'1.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'02',$vUrl2,$vUrl3,'2.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'03',$vUrl2,$vUrl3,'1.jpg')"/><![CDATA[","]]><xsl:value-of select="concat($vUrl1,'03',$vUrl2,$vUrl3,'2.jpg')"/><![CDATA[","]]>
        </xsl:for-each>
        <![CDATA["}]]>
        <![CDATA[set vAucID to {"]]>
        <xsl:for-each select="a">
            <xsl:sort select="substring-before(substring-after(./@href,'id,'),',var')"/>
            <xsl:variable name="vAucID" select="substring-before(substring-after(./@href,'id,'),',var')"/>
            <xsl:value-of select="concat($vAucID,'_001')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_002')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_003')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_004')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_005')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_006')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_007')"/><![CDATA[","]]><xsl:value-of select="concat($vAucID,'_008')"/><![CDATA[","]]>
        </xsl:for-each>
        <![CDATA["}]]>
        ...
        <xsl:for-each select="a">
            ...
            <xsl:element name="tss:reference">
                ...
                <xsl:element name="tss:attachments">
                    <xsl:variable name="vNum" select="'1,2,3,4,5,6,7,8'"/>
