        ...
        <xsl:element name="tss:senteContainer">
            ...
            <xsl:element name="tss:library">
                <xsl:element name="tss:references">
                    <xsl:apply-templates mode="m4"/> <!-- this is the line to trigger m1, m3, m4 -->
                </xsl:element>
            </xsl:element>
        </xsl:element>
    </xsl:template>
...
tell application "TextEdit"
    ...
    <xsl:template match="div[not(descendant::img)]" mode="m5">
        ...
        <xsl:variable name="vUrlImgBase">
            ...
            <xsl:if test="$pSearch!='7'"><xsl:text>"</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_1_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_2_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_3_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_4_L.jpg",</xsl:text></xsl:if>
            <xsl:if test="$pSearch='18'">
            ...
            <xsl:if test="$pSearch='7'">
                <xsl:text>"</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_00_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_01_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_02_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_03_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_04_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_05_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_06_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_07_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_08_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_09_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_010_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_011_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_012_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_013_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_014_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_015_L.jpg","</xsl:text><xsl:value-of select="$vUrlImgBase"/><xsl:text>_016_L.jpg",</xsl:text>
            </xsl:if>
        </xsl:if>
        ...
        <xsl:element name="tss:reference">
            ...
            <xsl:element name="tss:attachments">
                ...
                <xsl:if test="$pSearch='7'">
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_00_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_01_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_02_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_03_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_04_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_05_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_06_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_07_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_08_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_09_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_010_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_011_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_012_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_014_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_015_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                    <xsl:element name="tss:attachmentReference">
                        <xsl:element name="URL">
                            <xsl:value-of select="$vUrlImgBase"/><xsl:text>_016_L.jpg</xsl:text>
                        </xsl:element>
                    </xsl:element>
                </xsl:if>
            </xsl:element>
